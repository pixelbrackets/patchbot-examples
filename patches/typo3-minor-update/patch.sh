...
# Update TYPO3 core packages to the latest minor release
#
# Usage with Patchbot (filter by topic or name):
#   ./vendor/bin/patchbot patch-many typo3-minor-update --filter="topic:typo3"
#   ./vendor/bin/patchbot patch-many typo3-minor-update --filter="path:*typo3*"
#   ./vendor/bin/patchbot patch-many typo3-minor-update --filter="topic:typo3" --create-mr --dry-run
